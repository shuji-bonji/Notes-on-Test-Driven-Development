...
ここでは、VitestとTypeScriptを使用してクラスをテストするパターンについて説明します。

## 目次

1. [セットアップ](#セットアップ)
2. [シンプルなクラスのテスト](#シンプルなクラスのテスト)
3. [値オブジェクトのテスト](#値オブジェクトのテスト)
4. [ドメインオブジェクトのテスト](#ドメインオブジェクトのテスト)
5. [クラス継承のテスト](#クラス継承のテスト)
6. [インターフェース実装のテスト](#インターフェース実装のテスト)
7. [依存性注入を活用したテスト](#依存性注入を活用したテスト)
8. [プライベートメソッドのテスト戦略](#プライベートメソッドのテスト戦略)
9. [状態変化のテスト](#状態変化のテスト)
10. [実践的なヒント](#実践的なヒント)
